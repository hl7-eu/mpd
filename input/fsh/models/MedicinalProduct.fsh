...
* activeSubstance 0..* CodeableConcept "A.1.4.4 Active substance(s)" """All active substances according to ISO 11238. Referred to by ""common name"" in implementing directive 2012/52/EU."""				
  ...
  * ^binding.strength = #preferred					
* strength 0..* Ratio "A.1.4.4.1 Strength of the active substance(s)" """Presentation and/or concentration strength of the active substances. In addition, reference strength could be provided (Article 1 of Directive 2001/83/EC)."""				
...
* packageType 0..* CodeableConcept "A.1.4.8 Package type" """Type of the container, Examples: bottle, blister, box"""				
  * ^binding.description = "EDQM"
  * ^binding.strength = #preferred					
* PackageSize 0..* BackboneElement "A.1.4.9 Pack size" """Typically, the pack size is the number of unit of presentations in the package. 
