...
// A.1.2 is a grouper level in eHN guideline, not necessary to map?
...
* group[=].element[=].target.code = #MedicationRequest.medication
* group[=].element[=].target.display = ""					
* group[=].element[=].target.equivalence = #equivalent					
...
* group[=].element[=].target.code = #MedicationRequest.dispenseRequest.validityPeriod.end					
* group[=].element[=].target.display = ""					
* group[=].element[=].target.equivalence = #equivalent					
...
* group[=].element[+].code = #Prescription.details.reason					
* group[=].element[=].display = "A.1.5.10 Reason for prescription"					
* group[=].element[=].target.code = #MedicationRequest.reason					
* group[=].element[=].target.display = ""					
* group[=].element[=].target.relationship = #related-to			
