# Mapping to Profiles - HL7 Europe Medication Prescription and Dispense v0.1.0-ci-build
...
EHDS logical information models are provided by Xt-EHR project. Please read more about the models on [Logical Models page](logicalmodels.md).
