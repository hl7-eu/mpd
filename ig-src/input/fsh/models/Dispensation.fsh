...
* pharmacyIdentifier 0..* Identifier "B.1.4 Identifier of the pharmacy" """A unique number or code issued for the purpose of identifying a pharmacy [ISO/TS 27527:2010]; this may be a licence or registration number which can be used to trace the dispensing pharmacy."""				
