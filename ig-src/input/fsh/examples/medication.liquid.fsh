...
//Lösung (20 Tropfen = 4 Hübe) enthalten 51,45 mg Tilidinhydrochlorid-Hemihydrat (entsprechend 50 mg Tilidinhydrochlorid) und 4,40 mg Naloxonhydrochlorid-Dihydrat (entsprechend 4 mg Naloxonhydrochlorid).{% endif %}
{% if isR5 %}
Instance: 01A-Cefuroxime1500GenericExplicit
InstanceOf: MedicationEuMpd
Usage: #example
