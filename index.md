...
| | |
| :--- | :--- |
| *Official URL*:http://hl7.eu/fhir/mpd/ImplementationGuide/hl7.fhir.eu.mpd | *Version*:0.1.0-ci-build |
| Draft as of 2025-10-13 | *Computable Name*:Hl7EuMedPrescriptionDispenseIg |
...
```json
{
  ...
  "id" : "hl7.fhir.eu.mpd",
  "url" : "http://hl7.eu/fhir/mpd/ImplementationGuide/hl7.fhir.eu.mpd",
    ...
    "extension" : [
      ...
      },
      {
        "extension" : [
          ...
          {
            "url" : "value",
            "valueString" : "http://hl7.eu/fhir/mpd/history.html"
          }
        ],
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
      },
    ...
    "resource" : [
      {
        ...
        "exampleCanonical" : "http://hl7.eu/fhir/mpd/StructureDefinition/Medication-eu-mpd"
      },
      {
        "extension" : [
          {
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "RequestGroup/100B-RequestOrchestration"
        },
      ...
      },
      {
        ...
        "exampleCanonical" : "http://hl7.eu/fhir/mpd/StructureDefinition/MedicationRequest-eu-mpd"
      },
      {
        "extension" : [
          {
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "RequestGroup/300B-RequestOrchestration"
        },
      ...
      },
      {
        ...
        "exampleCanonical" : "http://hl7.eu/fhir/mpd/StructureDefinition/MedicationDispense-eu-mpd"
      },
      {
        "extension" : [
          {
      ...
      "page" : [
        ...
        },
        {
          "extension" : [
            {
              "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-page-name",
              "valueUrl" : "designchoices.html"
            }
          ],
          "nameUrl" : "designchoices.html",
        ...
        },
        {
          "extension" : [
            {
              "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-page-name",
              "valueUrl" : "medicationconcepts.html"
            }
          ],
          "nameUrl" : "medicationconcepts.html",
